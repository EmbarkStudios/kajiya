...
rem cargo run --bin bake --release -- --scene "assets/meshes2/336_lrm/scene.gltf" --scale 0.005 -o 336_lrm
...
rem cargo run --bin bake --release -- --scene "assets/meshes/RpgPackLite/RpgPackLite.gltf" --scale 0.2 -o village
rem cargo run --bin bake --release -- --scene "assets/meshes4/casa2.gltf" --scale 1.0 -o casa2
rem cargo run --bin bake --release -- --scene "assets/meshes4/countr-kitchen.gltf" --scale 0.25 -o countr-kitchen
rem cargo run --bin bake --release -- --scene "assets/meshes3/dp3_homework_4/scene.gltf" --scale 0.05 -o mini-battle
rem cargo run --bin bake --release -- --scene "assets/meshes4/kitchen.glb" --scale 0.5 -o kitchen