...
rem cargo run --release -- --scene "assets/meshes3/gas_stations_fixed/scene.gltf" --scale 0.01 --width 1920 --height 1080
rem cargo run --release -- --scene "assets/meshes/mireys_cute_gas_stove/scene.gltf" --scale 0.03 --width 1920 --height 1080
rem cargo run --release -- --scene "assets/meshes/sploosh-o-matic/scene.gltf" --scale 0.1
...
rem cargo run --release -- --scene "assets/meshes3/baba_yagas_hut/scene.gltf" --scale 0.333 --width 1920 --height 1080

rem cargo run --release -- --scene "assets/meshes3/tube_city_war/scene.gltf" --scale 1.0 --width 1920 --height 1080

rem cargo run --release -- --scene "assets/test-meshes/gi-01.gltf" --scale 1.0